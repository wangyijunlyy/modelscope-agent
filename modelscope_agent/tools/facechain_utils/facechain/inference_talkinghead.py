...
from .constants import tts_speakers_map
from .utils import join_worker_data_dir
...
class SadTalker():
    ...
    def __call__(self, *args, **kwargs) -> Any:
        ...
        inference = pipeline(
            'talking-head', model='wwd123/sadtalker', model_revision='v1.0.0')
        print('initialized sadtalker pipeline')
        video_path = inference(
            source_image, driven_audio=driven_audio, **kwargs)
